...
while (1):
    ...
    try:  # um erro ocorre se não encontrar nada na janela, pois não
        ...
        roi = frame[100:300, 400:600]  # tamanho da máscara

        cv2.rectangle(frame, (400, 100), (600, 300), (0, 255, 0), 0)  # leitura da máscara
        ...
        # break
            ...
            cv2.putText(frame, 'FIRE', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)
